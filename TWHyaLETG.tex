...
%%
Accretion onto low-mass stars can be probed with specific X-ray signatures observable with Chandra. Recent observations of the classical T Tauri star (CTTS) TW Hya indicate that these X-ray signatures show variability hinting at their accretion origin. We aim to reveal new accretion physics by observing TW Hya with Chandra/LETGS simultaneously with already planned HST UV observations in the ULYSSES program, director's
...
shock on the star. However, the densities in Ne~{\sc ix} and O~{\sc vii} indicate
...
will characterize the wind and we request five visits of 30 ks Chandra
...
(TODO: check numbers) in the O~{\sc vii} and Ne~{\sc ix} triplets, which are crucial for measuring the density and temperature.
